      ...
      <tbody>
        ...
        <?php foreach ($rows as $row) { ?>
          <tr>
            ...
            <td><a type="button" href="/pharmacy-management-system/pharmacist/manageOrders/updateOrder.php?orderId=<?php echo $row['oid'] ?>" class="btn btn-sm btn-outline-secondary">Update Order</a></td>
          </tr>
        <?php } ?>
