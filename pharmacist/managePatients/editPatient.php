<?php $title = "Edit Patient"; require('../../partials/boilerplate.inc.php')?>
...
<section class="container row mx-auto">
    <div class="col-lg-12">
        ...
        <form method="POST" class="validated-form" novalidate enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <a class="text-decoration-none btn btn-warning" href="/pharmacy-management-system/pharmacist/managePatients/patientsList.php">Return</a>
